...
export function Header() {
  return (
    <header className="sticky top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm">
      <nav className="mt-6 relative max-w-3xl w-full border border-border rounded-[0.3rem] mx-2 py-2.5 md:flex md:items-center md:justify-between md:py-0 md:pl-1 md:pr-3 md:mx-auto">
